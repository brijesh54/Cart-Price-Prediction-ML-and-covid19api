...
class RegistrationView(View):
    def get(self, request):
        return render(request, 'auth/signup&in.html')
    ...
    def post(self, request):
        ...
        if context['has_error']:
            return render(request, 'auth/signup&in.html', context, status=400)
        ...
        messages.add_message(request, messages.SUCCESS,
                             'account created succesfully please verify email')
...
class LoginView(View):
    ...
    def post(self, request):
        ...
        if context['has_error']:
            return render(request, 'auth/signup&in.html', status=401, context=context)
        login(request, user)
